        ...
        RebarTickingBlock
{
    ...
    public Component getOutput() {
        return this.itemStack == null || this.itemStack.isEmpty()
            ? Component.translatable("rebartranscendence.item.zot_collector.waila.none_item").color(colorToTextColor(Color.RED))
    ...
    public @Nullable WailaDisplay getWaila(@NotNull Player player) {
        return new WailaDisplay(isProcessing()
            ? Component.translatable("rebartranscendence.item.zot_collector.waila.running")
                .arguments(
            ...
            : Component.translatable("rebartranscendence.item.zot_collector.waila.not_running")
