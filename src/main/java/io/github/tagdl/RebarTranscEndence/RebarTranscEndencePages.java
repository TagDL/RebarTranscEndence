...
public class RebarTranscEndencePages {
    public static final SimpleStaticGuidePage TRANSC_ENDENCE = new SimpleStaticGuidePage(new NamespacedKey(RebarTranscEndence.getInstance(), "rebartranscendence_guide"));
    public static final SimpleStaticGuidePage ITEMS = new SimpleStaticGuidePage(new NamespacedKey(RebarTranscEndence.getInstance(), "rebartranscendence_items"));
